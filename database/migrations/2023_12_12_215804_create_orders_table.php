...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->string('or_emp_phone');
            $table->string('or_emp_email');
            $table->string('or_emp_no');
            $table->string('or_dept');
            $table->string('or_req');
            $table->string('or_order_pending');
            $table->string('or_material_right');
            $table->string('or_material_left');
            $table->string('or_lens_style_right');
            $table->string('or_lens_style_left');
            $table->string('or_lens_color_right');
            $table->string('or_lens_color_left');
            $table->string('or_ocht');
            $table->string('or_measurement_right');
            $table->string('or_measurement_left');
            ...
            $table->string('or_prism_in_right');
            $table->string('or_prism_in_left');
            ...
            $table->string('or_add_right');
$table->string('or_add_left');
$table->string('or_upper_add_right');
$table->string('or_upper_add_left');
$table->string('or_seg_height_right');
$table->string('or_set_height_left');
$table->string('or_tint_color_right');
$table->string('or_tint_color_left');
$table->string('or_tint_percent_right');
$table->string('or_tint_percent_left');
$table->string('or_mirror_right');
$table->string('or_mirror_left');
$table->string('or_coating_right');
$table->string('or_coating_left');
$table->string('or_frame_info');
$table->string('or_frame_manufacturer');
$table->string('or_frame_style');
$table->string('or_frame_color');
$table->string('or_frame_size');
$table->string('or_frame_side_shield');
$table->string('or_extra_ss');
$table->string('or_frame_case');
$table->string('or_add_on_1');
$table->string('or_add_on_2');
$table->string('or_add_on_3');
$table->string('or_notes');
